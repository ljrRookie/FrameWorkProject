...
import com.ljr.core.network.callback.IError;
import com.ljr.core.network.callback.IFailure;
import com.ljr.core.network.callback.IRequest;
import com.ljr.core.network.callback.ISuccess;
import com.ljr.core.network.callback.RequestCallbacks;
...
public class RequestClient {
    ...
    private void requestAction(HttpMethod httpMethod) {
        ...
        // OK HTTP 异步执行
        if (callResult != null) {
            RequestCallbacks requestCallbacks = new RequestCallbacks(iError, iFailure, iRequest, iSuccess);
            callResult.enqueue(requestCallbacks);
        }
